-- =============================================
-- FIREBASE NOTIFICATION ENHANCEMENTS
-- File: 030_firebase_notification_enhancements.sql
-- Date: 2024
-- Purpose: Enhance database for Firebase notifications
-- =============================================
...
-- PostgreSQL doesn't support PRINT, using comment instead
-- ✅ Firebase notification enhancements applied successfully! 