...
-- SIMPLE FUNCTION FIX
-- ============================================================================
-- This creates the missing database functions step by step

-- 1. First, let's create the basic helper categories function
...
-- 2. Create the assigned jobs function
...
BEGIN
    -- Get helper's active categories
...
-- 3. Create the calendar function
...
-- 4. Test with your specific helper
DO $$
DECLARE
    ...
    job_count INTEGER;
BEGIN
    -- Test the helper categories function
    SELECT get_helper_job_categories(test_helper_id) INTO categories;
    RAISE NOTICE 'Helper % has these ACTIVE categories: %', test_helper_id, categories;
    ...
    -- Show all helper_job_types for this helper
    RAISE NOTICE 'All job types for helper %:', test_helper_id;
    FOR categories IN 
...
SELECT 'Functions created successfully' as status, routine_name
