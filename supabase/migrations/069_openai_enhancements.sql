-- Migration: 069_openai_enhancements.sql
-- Description: OpenAI-specific optimizations for natural language conversation flow
-- Created: 2024-12-20
-- Enhances: 068_enhanced_ai_chatbot_system.sql

-- Add OpenAI-specific fields to conversation sessions
...
-- Add OpenAI-specific fields to job request drafts
...
-- Create indexes for better OpenAI performance
...
-- Enhanced function to save conversation with OpenAI message history
...
-- Enhanced function to get conversation history for OpenAI context
...
-- Enhanced job draft saving with OpenAI confidence scoring
