...
class User2IntroPage1 extends StatefulWidget {
  const User2IntroPage1({super.key});

  @override
  State<User2IntroPage1> createState() => _User2IntroPage1State();
}

class _User2IntroPage1State extends State<User2IntroPage1> with TickerProviderStateMixin {
            ...
            child: Container(
              ...
              child: SafeArea(
                ...
                child: Row(
                  ...
                  children: [
                    // Pagination Dots - Page 1 active (left to right: 1-2-3)
                    Row(
                      children: [
                        _buildDot(true),  // Page 1 - Active
