...
import '../pages/helper/helper_8_view_requests_page_private.dart';
...
import '../pages/helper/helper_21_profile_page_profile_tab.dart';
...
class NavigationService {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // Helpee Job Detail Routes (FIXED)
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const Helper8ViewRequestsPagePrivate(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/helper/profile',
        name: 'helper-profile',
        builder: (context, state) => const Helper21ProfilePageProfileTab(),
      ),
      GoRoute(
