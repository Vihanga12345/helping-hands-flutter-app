...
class HelpeePopup7JobResumed extends StatefulWidget {
  final VoidCallback? onClose;
  const HelpeePopup7JobResumed({Key? key, this.onClose}) : super(key: key);
  @override
  State<HelpeePopup7JobResumed> createState() => _HelpeePopup7JobResumedState();
}

class _HelpeePopup7JobResumedState extends State<HelpeePopup7JobResumed> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Job has been Resumed', textAlign: TextAlign.center, style: TextStyle().copyWith(fontSize: 24, color: Colors.black, height: 1.3)),
                      ),
  ...
  static void show(BuildContext context) {
    showDialog(context: context, barrierDismissible: false, barrierColor: Colors.transparent, builder: (BuildContext context) => HelpeePopup7JobResumed(onClose: () => Navigator.of(context).pop()));
  }
} 
