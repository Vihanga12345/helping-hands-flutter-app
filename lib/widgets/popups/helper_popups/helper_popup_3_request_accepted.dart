...
class HelperPopup3RequestAccepted extends StatefulWidget {
  ...
  @override
  State<HelperPopup3RequestAccepted> createState() =>
      _HelperPopup3RequestAcceptedState();
}

class _HelperPopup3RequestAcceptedState
    extends State<HelperPopup3RequestAccepted>
  ...
  static void show(BuildContext context) {
    showDialog(
        ...
        builder: (BuildContext context) => HelperPopup3RequestAccepted(
