...
class HelperPopup7JobResumed extends StatefulWidget {
  final VoidCallback? onClose;
  const HelperPopup7JobResumed({Key? key, this.onClose}) : super(key: key);
  @override
  State<HelperPopup7JobResumed> createState() => _HelperPopup7JobResumedState();
}

class _HelperPopup7JobResumedState extends State<HelperPopup7JobResumed> with TickerProviderStateMixin {
      ...
      return Opacity(opacity: _opacity.value, child: Container(width: double.infinity, height: double.infinity, color: Colors.black.withOpacity(0.3),
        child: Center(child: Transform.scale(scale: _scale.value, child: Container(width: 340, height: 295,
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Padding(padding: const EdgeInsets.symmetric(horizontal: 40), child: Text('Job has been Resumed', textAlign: TextAlign.center, style: TextStyle().copyWith(fontSize: 24, color: Colors.black, height: 1.3))),
  ...
  static void show(BuildContext context) => showDialog(context: context, barrierDismissible: false, barrierColor: Colors.transparent, builder: (context) => HelperPopup7JobResumed(onClose: () => Navigator.of(context).pop()));
} 
