...
class HelperPopup1AccountCreation extends StatefulWidget {
  final VoidCallback? onClose;
  const HelperPopup1AccountCreation({Key? key, this.onClose}) : super(key: key);
  @override
  State<HelperPopup1AccountCreation> createState() => _HelperPopup1AccountCreationState();
}

class _HelperPopup1AccountCreationState extends State<HelperPopup1AccountCreation> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Your Account has been created successfully', textAlign: TextAlign.center, style: TextStyle().copyWith(fontSize: 24, color: Colors.black, height: 1.3)),
                      ),
  ...
  static void show(BuildContext context) {
    showDialog(context: context, barrierDismissible: false, barrierColor: Colors.transparent, builder: (BuildContext context) => HelperPopup1AccountCreation(onClose: () => Navigator.of(context).pop()));
  }
} 
